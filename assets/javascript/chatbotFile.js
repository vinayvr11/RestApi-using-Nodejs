document.addEventListener('DOMContentLoaded', function () {
    ...
    link1.setAttribute('href','https://lit-lowlands-81249.herokuapp.com/assets/stylesheets/index.css');

    let script1 = document.createElement('SCRIPT');
    let script2 = document.createElement('SCRIPT');
    script1.setAttribute('src', 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/umd/popper.min.js');
    script2.setAttribute('src', 'https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js');
    ...
    button.className = 'round-button mr-3 mb-3 shadow justify-content-center align-items-center welcome';
